...
Item {
    ...
    ListModel {
        ...
        ListElement { letter: "z"; firstSymbol: "6"; secondSymbol: "6"; expLetter: "å" }
        ...
        ListElement { letter: "o"; firstSymbol: "9"; secondSymbol: "9"; expLetter: "ß" }
    ...
    ListModel {
        ...
        ListElement { letter: "l"; firstSymbol: "/"; secondSymbol: "="; expLetter: "ü" }
    }
    ListModel {
        id:third
        ListElement { letter: "y"; firstSymbol: "_"; secondSymbol: "\\"; expLetter: "ò" }
