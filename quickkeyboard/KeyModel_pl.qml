...
Item {
    ...
    ListModel {
        ...
        ListElement { letter: "y"; firstSymbol: "6"; secondSymbol: "6"; expLetter: "ř" }
        ...
        ListElement { letter: "p"; firstSymbol: "0"; secondSymbol: "0"; expLetter: "ý" }
    }
    ListModel {
        id:second
    ...
    ListModel {
        id:third
        ListElement { letter: "z"; firstSymbol: "_"; secondSymbol: "\\"; expLetter: "ż" }
        ListElement { letter: "x"; firstSymbol: "\""; secondSymbol: ":"; expLetter: "ź" }
