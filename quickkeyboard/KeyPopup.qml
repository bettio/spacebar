...
/*Item {
    ...
    function popup(keybutton, inputPanel) {
        ...
        var PopupGlobalTop = KeyButtonGlobalTop - height - root.verticalSpacing * 1.5;
...
Item {
    ...
    function popup(keybutton, inputPanel) {
        ...
        var PopupGlobalLeft = KeyButtonGlobalLeft - (width - keybutton.width) / 2;
        var PopupGlobalTop = KeyButtonGlobalTop - height - root.verticalSpacing * 1.5;
        var PopupLeft = keyPopup.parent.mapFromItem(inputPanel, PopupGlobalLeft, PopupGlobalTop).x;
        y = keyPopup.parent.mapFromItem(inputPanel, PopupGlobalLeft, PopupGlobalTop).y;
        if (PopupGlobalLeft < 0)
        {
            x = 0;
        }
