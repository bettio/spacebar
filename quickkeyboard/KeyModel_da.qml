...
Item {
    ...
    ListModel {
        id:first
        ListElement { letter: "q"; firstSymbol: "1"; secondSymbol: "1"; expLetter: "ç" }
        ListElement { letter: "w"; firstSymbol: "2"; secondSymbol: "2"; expLetter: "ð" }
        ...
        ListElement { letter: "o"; firstSymbol: "9"; secondSymbol: "9"; expLetter: "ä" }
    ...
    ListModel {
        ...
        ListElement { letter: "k"; firstSymbol: "?"; secondSymbol: "]"; expLetter: "æ" }
        ListElement { letter: "l"; firstSymbol: "/"; secondSymbol: "="; expLetter: "ø" }
    }
    ListModel {
        id:third
