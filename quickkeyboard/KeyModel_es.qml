...
Item {
    ...
    ListModel {
        ...
        ListElement { letter: "y"; firstSymbol: "6"; secondSymbol: "6"; expLetter: "â" }
    ...
    ListModel {
        ...
        ListElement { letter: "ñ"; firstSymbol: "="; secondSymbol: "·"; expLetter: "ô" }
    }
    ListModel {
        id:third
        ...
        ListElement { letter: "b"; firstSymbol: ")"; secondSymbol: "°"; expLetter: "ü" }
