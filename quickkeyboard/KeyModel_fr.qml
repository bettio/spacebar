...
Item {
    ...
    ListModel {
        id:first
        ListElement { letter: "a"; firstSymbol: "1"; secondSymbol: "1"; expLetter: "à" }
        ListElement { letter: "z"; firstSymbol: "2"; secondSymbol: "2"; expLetter: "á" }
    ...
    ListModel {
        id:second
        ListElement { letter: "q"; firstSymbol: "!"; secondSymbol: "|"; expLetter: "è" }
        ...
        ListElement { letter: "l"; firstSymbol: "/"; secondSymbol: "="; expLetter: "æ" }
        ListElement { letter: "m"; firstSymbol: "+"; secondSymbol: "€"; expLetter: "ü" }
    }
    ListModel {
        id:third
        ListElement { letter: "w"; firstSymbol: "_"; secondSymbol: "\\"; expLetter: "ò" }
        ...
        ListElement { letter: "b"; firstSymbol: ")"; secondSymbol: "°"; expLetter: "ø" }
        ListElement { letter: "n"; firstSymbol: "-"; secondSymbol: "~"; expLetter: "ù" }
        ListElement { letter: "œ"; firstSymbol: "="; secondSymbol: "+"; expLetter: "ú" }
    }
}
